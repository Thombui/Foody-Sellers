    ...
    else
    {
      if(passwordController.text == confirmPasswordController.text)
      {
        ...
        if(confirmPasswordController.text.isNotEmpty && passwordController.text.isNotEmpty && nameController.text.isNotEmpty && locationController.text.isNotEmpty && phoneController.text.isNotEmpty)
        {
          ...
          fStrorage.Reference reference = fStrorage.FirebaseStorage.instance.ref().child("sellers").child(fileName);
              ...
              child: Column(
                children: [
                  ...
                  CustomTextField(
                    ...
                    hintText: "Địa chỉ Cafe/ Restaurant ",
                    isObsecre: false,
                    enabled: true,
                  ),
                  Container(
